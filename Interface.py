...
class Interface:
    ...
    def main_frame(self):
        ...
        # Save Button
        self.submit = Button(self.main, text="  Submit ", font=("Helvetica 15"), bg='#99dd1c', fg="white", borderwidth = 2, width = 10, relief="ridge", command=self.submit_check).grid(column= 3, row=6 ,padx=20,sticky="NSEW")  
    def submit_check(self):
      ...
      #  age_error2 = self.player.age_verification2()
        #Label(self.main, text=age_error2, fg='red', font=30, bg="skyblue").grid(column=3, row=4, sticky='w')
        age_int_check = self.player.age_verification()
        Label(self.main, text=age_int_check, fg='red', font=30, bg="skyblue").grid(column=3, row=4, sticky='w')
